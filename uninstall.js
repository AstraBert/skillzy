...
const binp = path.join(cargoDir, "bin", "skillzy");

if (fs.existsSync(binp)) {
  console.log("Uninstalling skillzy...");
  exec(`cargo uninstall skillzy`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("skillzy not found skipping!");
}
